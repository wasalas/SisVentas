...
namespace CapaPresentacion
{
    public partial class frmVistaArticulo_Venta : Form
    {
        ...
        {
            this.dataListado.DataSource = NVenta.MostrarArticulo_Venta_Nombre(txtBuscar.Text);
        ...
        {
            this.dataListado.DataSource = NVenta.MostrarArticulo_Venta_Codigo(txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total filas : " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        {
            if (this.cbBuscar.Text.Equals("Codigo"))
            {
